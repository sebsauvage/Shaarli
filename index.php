...
/* GET an URL.
   Input: $url : URL to get (http://...)
          $timeout : Network timeout (will wait this many seconds for an answer before giving up).
...
class linkdb implements Iterator, Countable, ArrayAccess
{
    ...
    // Case insensitive search among links (in the URL, title and description). Returns filtered list of links.
...
function showRSS()
{
    ...
    $LINKSDB=new linkdb(isLoggedIn() || $GLOBALS['config']['OPEN_SHAARLI']);  // Read links from database (and filter private links if user is not logged in).
